...
void main() {
  ...
  group("popular movie api service", () {
    ...
    test("should get 404 error when make HTTP request", () {
      ...
      //  Assert
      expect(
          () => result(params), throwsA(const TypeMatcher<ServerException>()));
    });
  ...
  group("upcoming movie api service", () {
    test("should make HTTP request from upcoming movie api service", () async {
      //  Arrange
      ...
      //  Act
      final result = await sut!.getUpcomingMoviesFromApiService(upComingParams);
      //  Assert
